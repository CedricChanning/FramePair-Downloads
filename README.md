...
FramePair helps landscape photos, including common 16:9 images, work better on vertical screens. Stack two matching photos into a taller composition with Merge, or divide one wide photo into consecutive left and right images with Split. Direct export is available when no rearrangement is needed.

[Download FramePair 0.1 DMG](https://github.com/CedricChanning/FramePair-Downloads/releases/download/v0.1/FramePair-0.1-macOS-arm64.dmg) · [All releases](https://github.com/CedricChanning/FramePair-Downloads/releases) · [Report an issue](https://github.com/CedricChanning/FramePair-Downloads/issues)

FramePair 0.1 is a pre-release. The app is signed with Developer ID and notarized by Apple.
...
1. Download `FramePair-0.1-macOS-arm64.dmg`
...
Download `FramePair-0.1-macOS-arm64.zip`, extract it, and move `FramePair.app` into Applications.
...
```bash
cd ~/Downloads
shasum -a 256 -c FramePair-0.1-macOS-arm64.dmg.sha256
```
...
| Package | SHA-256 |
|---|---|
| `FramePair-0.1-macOS-arm64.dmg` | `e203f68ea10772907fa62aef96fc960ff7be31437349797f353efab25e126611` |
| `FramePair-0.1-macOS-arm64.zip` | `f0ad78ae95aa230ff641c7f8564e00dc7328d6ca1960fa708f5e0ca2328d7bac` |

## Features

- Local JPEG input from any source
- Direct export without unnecessary JPEG recompression
- Vertical Merge stacks two matching photos into a taller composition
